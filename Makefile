...
BONUS_OBJ = ft_lstadd_back.o ft_lstclear.o ft_lstlast.o ft_lstnew.o ft_lstadd_front.o ft_lstdelone.o ft_lstmap.o ft_lstsize.o ft_lstiteri.o
BONUS_SRC = ft_lstadd_back.c ft_lstclear.c ft_lstlast.c ft_lstnew.c ft_lstadd_front.c ft_lstdelone.c ft_lstmap.c ft_lstsize.c ft_lstiteri.c
...
$(BONUS_OBJ) : $(BONUS_SRC)
	cc -c -Wall -Werror -Wextra $(BONUS_SRC)
clean:
	-rm -f $(OBJ) $(BONUS_OBJ)
fclean: clean
	-rm -f $(NAME) $(BONUS_OBJ)
